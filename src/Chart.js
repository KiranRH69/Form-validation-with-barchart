...
const sample = [
        {category:'A', quantity: Math.floor(Math.random()*100)},
        {category:'B', quantity: Math.floor(Math.random()*100)},
        {category:'C', quantity: Math.floor(Math.random()*100)},
        {category:'D', quantity: Math.floor(Math.random()*100)}
]
